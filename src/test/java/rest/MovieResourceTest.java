...
public class MovieResourceTest {
    ...
    public void testMovieCount() {
        given().
              //  get("/movie/count")
                get("http://localhost:7777/api/movie/count")
                .then()
                .assertThat()
    ...
    public void testGetAll() {
         given()
                .when().
                get("http://localhost:7777/api/movie/all").
    ...
    public void testFindByTitleNotFound() {
       given()
                .when().
                get("http://localhost:7777/api/movie/all").
               //Titlen Superman ved vi, ikke findes.
                then().assertThat().body("title", not(hasItems("Superman")));
    }
